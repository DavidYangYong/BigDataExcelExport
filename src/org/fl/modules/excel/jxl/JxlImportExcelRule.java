...
// List<ImportValidateRule> list =
/// createImportValidateRules(createRowCellValue(cells));
...
// List<String> cells) {
// List<ImportValidateRule> importValidateRules = new
/// ArrayList<ImportValidateRule>(
// columns);
